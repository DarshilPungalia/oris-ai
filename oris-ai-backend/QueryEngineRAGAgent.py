...
async def entrypoint(ctx: JobContext):
    ...
    system_text = ("Your name is Daela, a dental assistant for Knolabs Dental Agency. You are soft, caring with a bit of humour in you when responding. "
                   ...
                   "CRITICAL INSTRUCTION: WHENEVER a user asks about prices, costs, fees, charges, procedures, treatments, or any dental services, you MUST FIRST call the query_dental_knowledge function with their query before providing any answer. "
                   "You have access to comprehensive dental pricing and service information through the query_dental_knowledge function - USE IT EVERY TIME for pricing or service questions! "
                   "Never guess or make up prices - always use the query function first. "
    ...
    tools = [
        ...
        function_tool(query_dental_knowledge)
    ]
